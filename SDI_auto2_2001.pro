...
print,'Nell'' OP specificato sono presenti i seguenti trigger:'
...
if (n EQ 1) then n = 0b
printf,25
print,'sono presenti ', n, '  files'
printf,25 ,'sono presenti ', n, '  files'
print,'sono presenti ', tn, '  trigger completi'
printf,25 ,'sono presenti ', tn, '  trigger completi'
...
plot,[1.0,0,0,0]##x,[1.0,0,0,0]##y
plot,[0,1.0,0,0]##x,[0,1.0,0,0]##y
plot,[0,0,1.0,0]##x,[0,0,1.0,0]##y
plot,[0,0,0,1.0]##x,[0,0,0,1.0]##y
...
openu,1,'risultati.log',APPEND=1
printf,1,' '
...
REBIN2:openu,1,'risultati.log',APPEND=1
printf,1,' '
...
FINEFINALE:
	...
	;printf, 25
	;printf, 25, 'il trigger non e'' valido'
	;printf, 25 
