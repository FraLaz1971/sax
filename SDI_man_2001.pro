...
PRINCIPALE:print,' '
print,'Immetti 1 per accorpare, 2 per cambiare scala, 0 per continuare o 3 per passare al riconoscimento degli eventi'
;read,cosfai
cosfai = 1 ; **** modifica 2001 ****
if cosfai EQ 0 then goto,FINE
if cosfai EQ 1 then goto,REBIN
if cosfai EQ 2 then goto,RISCALA
if cosfai EQ 3 then goto,FINE3
goto,PRINCIPALE
...
if fatto12 EQ 1b then goto,FINE
...
plot,[1.0,0,0,0]##xr,[1.0,0,0,0]##yr
plot,[0,1.0,0,0]##xr,[0,1.0,0,0]##yr
plot,[0,0,1.0,0]##xr,[0,0,1.0,0]##yr
plot,[0,0,0,1.0]##xr,[0,0,0,1.0]##yr
...
print,'Immetti 0 per continuare, o 1 per accorpare i dati'
;read,chevuoi ; **** modifica 2001 ****
chevuoi = 0b
if chevuoi EQ 0 then goto,FINE3
if chevuoi EQ 1 then goto,REBIN
goto,FINE2
...
;read,cosavuoifareora **** modifica 2001 ****
...
print, 'premere un tasto e [ENTER] per terminare'
read, b   
